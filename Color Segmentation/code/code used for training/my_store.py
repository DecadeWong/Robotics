...
red_area = pickle.load (redarea_obj)
redarea_obj.close()
...
#for index, test_area in enumerate(area):
#cv2.drawContours(k, final_contours, -1, (0,255,0), 1)
#box_area=[]
...
#box_y_middle = box[0, 1] + box[1,1] + box[2,1] +box[3,1]
#box_x_middle = box[0, 0] + box[1,0] + box[2,0] +box[3,0]
#for position in box:
 #   if position[1] > box_y_middle & position[0] < box_x_middle |
